    ...
    <div class="mk-grid">
        ...
        <div class="mk-card">
            <div class="mk-card-body">
                ...
                <form action="<?php echo e(route('pengguna.admin.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mk-form-group">
                        <label class="mk-label">Nama Lengkap</label>
                        <input type="text" name="name" class="mk-input" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama lengkap" required>
                        <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="mk-error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mk-form-group">
                        ...
                        <input type="text" name="username" class="mk-input" value="<?php echo e(old('username')); ?>" placeholder="cth: adminbaru" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mk-form-group">
                        ...
                        <input type="email" name="email" class="mk-input" value="<?php echo e(old('email')); ?>" placeholder="email@contoh.com" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mk-card">
            <div class="mk-card-body">
                ...
                <form action="<?php echo e(route('pengguna.user.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mk-form-group">
                        <label class="mk-label">Nama Lengkap</label>
                        <input type="text" name="name" class="mk-input" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama lengkap" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mk-form-group">
                        <label class="mk-label">Username</label>
                        <input type="text" name="username" class="mk-input" value="<?php echo e(old('username')); ?>" placeholder="cth: userbaru" required>
                        <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mk-card">
        ...
        <div style="padding-top: 24px;">
            <form action="<?php echo e(route('pengguna.index')); ?>" method="GET" class="mk-toolbar">
                <div class="mk-search-wrapper">
                    <i class="ph ph-magnifying-glass"></i>
                    <input type="text" name="search" class="mk-search-input" placeholder="Cari nama, username, atau email..." value="<?php echo e(request('search')); ?>">
                </div>
                <div>
                    <select name="role" class="mk-filter-select" onchange="this.form.submit()">
                        ...
                        <?php endif; ?>
                        <option value="user" <?php echo e(request('role') == 'user' ? 'selected' : ''); ?>>Pengguna</option>
                    </select>
                </div>
            </form>
        </div>
            ...
            <table class="mk-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <div style="font-weight: 500; color: #0f172a;"><?php echo e($emp->name); ?></div>
                            </td>
                            <td><span style="color: #64748b;"><?php echo e('@' . $emp->username); ?></span></td>
                            <td><?php echo e($emp->email); ?></td>
                            <td>
                                <?php if($emp->role === 'super-admin'): ?>
                                    <span class="mk-badge mk-badge-super">Super Admin</span>
                                <?php elseif($emp->role === 'admin'): ?>
                            ...
                            <td>
                                <?php if($emp->must_change_password): ?>
                            ...
                            <td style="text-align: center;">
                                <div class="mk-dropdown">
                                    <button type="button" class="mk-action-btn" onclick="toggleDropdown(event, <?php echo e($emp->id); ?>)">
                                        <span style="font-size: 14px; font-weight: bold;">&#9662;</span>
                                    </button>
                                    <div class="mk-dropdown-menu" id="dropdown-<?php echo e($emp->id); ?>">
                                        <a href="javascript:void(0)" onclick="openModal('modal-detail-<?php echo e($emp->id); ?>')"><i class="ph ph-eye" style="font-size: 18px;"></i> Detail</a>
                                        
                                        <?php if(auth()->user()->role === 'super-admin' || (auth()->user()->role === 'admin' && $emp->role === 'user')): ?>
                                            <?php if(auth()->id() !== $emp->id): ?>
                                                <a href="javascript:void(0)" onclick="openModal('modal-edit-<?php echo e($emp->id); ?>')"><i class="ph ph-pencil-simple" style="font-size: 18px;"></i> Edit</a>
                                                <a href="javascript:void(0)" onclick="openModal('modal-reset-<?php echo e($emp->id); ?>')"><i class="ph ph-key" style="font-size: 18px;"></i> Reset Password</a>
                                                <a href="javascript:void(0)" onclick="openModal('modal-status-<?php echo e($emp->id); ?>')"><i class="ph ph-toggle-right" style="font-size: 18px;"></i> Ubah Status</a>
                                                <div class="mk-dropdown-divider"></div>
                                                <a href="javascript:void(0)" onclick="openModal('modal-delete-<?php echo e($emp->id); ?>')" class="text-danger"><i class="ph ph-trash" style="font-size: 18px;"></i> Hapus</a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <!-- 1. Modal Detail -->
    <div class="mk-modal-overlay" id="modal-detail-<?php echo e($emp->id); ?>">
        <div class="mk-modal">
            <div class="mk-modal-header">
                <h3 class="mk-modal-title">Detail Pengguna</h3>
                <button type="button" class="mk-modal-close" onclick="closeModal('modal-detail-<?php echo e($emp->id); ?>')"><i class="ph ph-x"></i></button>
            </div>
            <div class="mk-modal-body">
                <div style="margin-bottom: 12px;"><strong>Nama Lengkap:</strong> <br> <?php echo e($emp->name); ?></div>
                <div style="margin-bottom: 12px;"><strong>Username:</strong> <br> <?php echo e($emp->username); ?></div>
                <div style="margin-bottom: 12px;"><strong>Email:</strong> <br> <?php echo e($emp->email); ?></div>
                <div style="margin-bottom: 12px;"><strong>Role:</strong> <br> <?php echo e(strtoupper(str_replace('-', ' ', $emp->role))); ?></div>
                <div style="margin-bottom: 12px;"><strong>Status:</strong> <br> <?php echo e($emp->must_change_password ? 'Menunggu Setup' : 'Aktif'); ?></div>
            </div>
            <div class="mk-modal-footer">
                <button type="button" class="mk-btn-outline" onclick="closeModal('modal-detail-<?php echo e($emp->id); ?>')">Tutup</button>
            </div>
        </div>
    </div>
    ...
    <?php if(auth()->user()->role === 'super-admin' || (auth()->user()->role === 'admin' && $emp->role === 'user')): ?>
        <?php if(auth()->id() !== $emp->id): ?>
            <!-- 2. Modal Edit -->
            <div class="mk-modal-overlay" id="modal-edit-<?php echo e($emp->id); ?>">
                <form action="<?php echo e(route('pengguna.update', $emp->id)); ?>" method="POST" class="mk-modal">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="mk-modal-header">
                        <h3 class="mk-modal-title">Edit Pengguna</h3>
                        <button type="button" class="mk-modal-close" onclick="closeModal('modal-edit-<?php echo e($emp->id); ?>')"><i class="ph ph-x"></i></button>
                    </div>
                    <div class="mk-modal-body">
                        <div class="mk-form-group">
                            <label class="mk-label">Nama Lengkap</label>
                            <input type="text" name="name" class="mk-input" value="<?php echo e($emp->name); ?>" required>
                        </div>
                        <div class="mk-form-group">
                            <label class="mk-label">Username</label>
                            <input type="text" name="username" class="mk-input" value="<?php echo e($emp->username); ?>" required>
                        </div>
                        <div class="mk-form-group">
                            <label class="mk-label">Email</label>
                            <input type="email" name="email" class="mk-input" value="<?php echo e($emp->email); ?>" required>
                        </div>
                    </div>
                    <div class="mk-modal-footer">
                        <button type="button" class="mk-btn-outline" onclick="closeModal('modal-edit-<?php echo e($emp->id); ?>')">Batal</button>
            ...
            <div class="mk-modal-overlay" id="modal-reset-<?php echo e($emp->id); ?>">
                <form action="<?php echo e(route('pengguna.reset', $emp->id)); ?>" method="POST" class="mk-modal">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="mk-modal-header">
                        <h3 class="mk-modal-title">Reset Password</h3>
                        <button type="button" class="mk-modal-close" onclick="closeModal('modal-reset-<?php echo e($emp->id); ?>')"><i class="ph ph-x"></i></button>
                    </div>
                    <div class="mk-modal-body">
                        <p style="font-size: 14px; color: #475569; margin-bottom: 16px;">
                            Reset password untuk <strong><?php echo e($emp->name); ?></strong>. Pengguna akan diwajibkan mengganti password pada saat login berikutnya.
                        </p>
                        <div class="mk-form-group">
                    ...
                    <div class="mk-modal-footer">
                        <button type="button" class="mk-btn-outline" onclick="closeModal('modal-reset-<?php echo e($emp->id); ?>')">Batal</button>
            ...
            <!-- 4. Modal Ubah Status -->
            <div class="mk-modal-overlay" id="modal-status-<?php echo e($emp->id); ?>">
                <form action="<?php echo e(route('pengguna.status', $emp->id)); ?>" method="POST" class="mk-modal">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
                    <div class="mk-modal-header">
                        <h3 class="mk-modal-title">Ubah Status Akun</h3>
                        <button type="button" class="mk-modal-close" onclick="closeModal('modal-status-<?php echo e($emp->id); ?>')"><i class="ph ph-x"></i></button>
                    </div>
                    <div class="mk-modal-body">
                        <p style="font-size: 14px; color: #475569; margin-bottom: 0;">
                            Apakah Anda yakin ingin mengubah status akun <strong><?php echo e($emp->name); ?></strong>?
                        </p>
                    </div>
                    <div class="mk-modal-footer">
                        <button type="button" class="mk-btn-outline" onclick="closeModal('modal-status-<?php echo e($emp->id); ?>')">Batal</button>
            ...
            <!-- 5. Modal Hapus -->
            <div class="mk-modal-overlay" id="modal-delete-<?php echo e($emp->id); ?>">
                <form action="<?php echo e(route('pengguna.destroy', $emp->id)); ?>" method="POST" class="mk-modal">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <div class="mk-modal-header">
                        <h3 class="mk-modal-title">Hapus Akun</h3>
                        <button type="button" class="mk-modal-close" onclick="closeModal('modal-delete-<?php echo e($emp->id); ?>')"><i class="ph ph-x"></i></button>
                    </div>
                    <div class="mk-modal-body">
                        <p style="font-size: 14px; color: #475569; margin-bottom: 0;">
                            Apakah Anda yakin ingin menghapus akun <strong><?php echo e($emp->name); ?></strong>? Tindakan ini bersifat permanen dan tidak dapat dibatalkan.
                        </p>
                    </div>
                    <div class="mk-modal-footer">
                        <button type="button" class="mk-btn-outline" onclick="closeModal('modal-delete-<?php echo e($emp->id); ?>')">Batal</button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\InsightHubBaru\frontend\resources\views/pages/Master/pengguna.blade.php ENDPATH**/ ?>