<div id="tab-analitik" class="dashboard-container">
    ...
    <div style="margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
        ...
        <span style="background: #0f172a; color: #fff; padding: 0.3rem 0.75rem; border-radius: 2rem; font-size: 0.8rem; font-weight: 600; display: flex; align-items: center; gap: 0.35rem;">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg> <?php echo e($activeLabel); ?>
        ...
        <span style="background: #e0e7ff; color: #4f46e5; padding: 0.3rem 0.75rem; border-radius: 2rem; font-size: 0.8rem; font-weight: 600; display: flex; align-items: center; gap: 0.35rem;">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg> <?php echo e($activePeriode); ?>
        ...
        <span style="background: #dcfce7; color: #166534; padding: 0.3rem 0.75rem; border-radius: 2rem; font-size: 0.8rem; font-weight: 600; display: flex; align-items: center; gap: 0.35rem;">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> <?php echo e($aTotal); ?> konten
        </span>
    </div>
    ...
    <div class="grid-2-1" style="margin-bottom: 2rem;">
        ...
        <div class="card">
            ...
            <?php $rankedPlatforms = collect($platformStats)->sortByDesc('reach'); ?>
            <div style="display: flex; flex-direction: column; gap: 0.5rem; margin-top: 0.75rem;">
                <?php $__currentLoopData = $rankedPlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platName => $pStat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $rank = $loop->iteration; ?>
                <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.6rem; border-radius: 10px; background: <?php echo e($rank === 1 ? '#f8fafc' : 'transparent'); ?>;">
                    <div style="width: 26px; height: 26px; border-radius: 50%; background: <?php echo e($rank === 1 ? '#fac775' : '#f1f5f9'); ?>; color: <?php echo e($rank === 1 ? '#633806' : '#64748b'); ?>; display: flex; align-items: center; justify-content: center; font-size: 0.75rem; font-weight: 600; flex-shrink: 0;"><?php echo e($rank); ?></div>
                    <?php
                    ...
                    ?>
                    <div style="width: 32px; height: 32px; border-radius: 6px; display: inline-flex; align-items: center; justify-content: center; background: <?php echo e($bgSoft); ?>; color: <?php echo e($pStat['color']); ?>; flex-shrink: 0;">
                        <?php if($platName == 'instagram'): ?>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                        <?php elseif($platName == 'facebook'): ?>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                        <?php elseif($platName == 'tiktok'): ?>
                        ...
                        <?php elseif($platName == 'youtube' || $platName == 'yt-video' || $platName == 'yt-shorts' || $platName == 'yt-live'): ?>
                    ...
                    <div style="flex: 1; min-width: 0;">
                        <div style="font-size: 0.875rem; font-weight: 600; color: #0f172a;"><?php echo e(ucfirst($platName)); ?></div>
                        <div style="font-size: 0.75rem; color: #64748b;"><?php echo e($pStat['count']); ?> konten &middot; <?php echo e($pStat['rate']); ?>% ER</div>
                    </div>
                    <div style="font-size: 1rem; font-weight: 600; color: #0f172a; white-space: nowrap;"><?php echo e(number_format($pStat['reach'])); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php else: ?>
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            <div class="card">
                ...
                <?php $avgCtRate = collect($contentTypeStats)->avg('rate'); ?>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                    ...
                    <div style="background: #f8fafc; border-radius: 10px; padding: 0.75rem; text-align: center;">
                        <div style="width: 56px; height: 56px; border-radius: 50%; margin: 0 auto 6px; background: conic-gradient(<?php echo e($gaugeColor); ?> 0% <?php echo e($gaugePct); ?>%, #e2e8f0 <?php echo e($gaugePct); ?>% 100%); display: flex; align-items: center; justify-content: center;">
                            <div style="width: 40px; height: 40px; border-radius: 50%; background: #f8fafc; display: flex; align-items: center; justify-content: center; font-size: 0.72rem; font-weight: 600; color: #0f172a;"><?php echo e(number_format($ctStat['rate'], 1)); ?>%</div>
                        </div>
                        <div style="font-size: 0.75rem; font-weight: 600; color: #0f172a; display: inline-flex; align-items: center; gap: 0.35rem; margin: 0 auto 0.25rem; justify-content: center;">
                            ...
                            <?php elseif(str_contains($n, 'reels')): ?>
                            ...
                            <?php elseif(str_contains($n, 'video')): ?>
                            ...
                            <?php elseif(str_contains($n, 'post') || str_contains($n, 'image') || str_contains($n, 'feed')): ?>
                            ...
                            <?php endif; ?>
                            <span><?php echo e(ucfirst($ctName ?: 'Lainnya')); ?></span>
                        </div>
                        <div style="font-size: 0.7rem; color: #64748b;"><?php echo e($ctStat['count']); ?> konten</div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php else: ?>
        ...
        <div class="card" style="padding: 0;">
            ...
            <div style="overflow-x: auto;">
                <table class="data-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $top10Likes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td style="font-weight: 700; color: <?php echo e($i < 3 ? '#db2777' : '#64748b'); ?>; font-size: 0.9rem;"><?php echo e($i + 1); ?></td>
                            <td>
                                <div style="font-size: 0.85rem; font-weight: 600; color: #0f172a; max-width: 160px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                    <?php echo e($metric->judul_konten ?: 'Konten ' . ucfirst($metric->platform)); ?>
                            ...
                            <td style="font-size: 0.8rem;"><?php echo e(ucfirst($metric->platform)); ?></td>
                            <td style="text-align: right; font-weight: 600; font-size: 0.875rem; color: #db2777;"><?php echo e(number_format($metric->likes)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr><td colspan="4" style="text-align: center; color: #64748b; padding: 2rem;">Tidak ada data.</td></tr>
                        <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const rawData = <?php echo json_encode($chartKategoriData, 15, 512) ?>;
...
</script><?php /**PATH C:\laragon\www\InsightHubBaru\frontend\resources\views/pages/Dashboard/analitik.blade.php ENDPATH**/ ?>