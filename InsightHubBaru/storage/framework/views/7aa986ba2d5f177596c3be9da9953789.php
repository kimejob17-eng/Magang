    ...
    <div class="platform-form-card">
        <div class="platform-form-header" style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 1rem;">
            <div style="display: flex; gap: 1rem; align-items: center;">
                ...
                <div>
                    <h2 style="font-size: 1.1rem; font-weight: 700; color: #0f172a; margin-bottom: 0.25rem;">YouTube Video Data</h2>
                    <p style="font-size: 0.8rem; color: #64748b; margin: 0;">Manual data entry for YouTube Videos.</p>
                </div>
            </div>
            <button type="button" class="btn" onclick="openImportModal('yt-video')" style="cursor: pointer; position: relative; z-index: 10; background: #10b981; color: white; border: none; font-weight: 500; font-size: 0.85rem; padding: 0.5rem 1rem; border-radius: 2rem; display: flex; align-items: center; gap: 6px; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
        ...
        <form id="form-yt-video" action="<?php echo e(route('dashboard.metrics.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div id="method-container-yt-video"></div>
            <input type="hidden" name="platform" value="yt-video">
            <input type="hidden" name="metric_id" id="metric-id-yt-video" value="">
            ...
            <div class="form-row" style="margin-top: 1rem;">
                <div class="form-group" style="margin-bottom: 0;">
                    <button type="button" id="btn-cancel-video" class="btn" style="display:none; width: 100%; justify-content: center; background: #f8fafc; color: #64748b;" onclick="resetFormYTVideo()">Batal Edit</button>
                    <button type="reset" id="btn-reset-video" class="btn" style="width: 100%; justify-content: center; background: #f8fafc; color: #64748b;">Reset Form</button>
                </div>
                <div class="form-group" style="margin-bottom: 0;">
                    <button type="submit" id="btn-submit-yt-video" class="btn btn-primary" style="width: 100%; justify-content: center; background: #ff0000; border-color: #ff0000;"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 4px;"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path><polyline points="17 21 17 13 7 13 7 21"></polyline><polyline points="7 3 7 8 15 8"></polyline></svg> Simpan Data</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="card" style="margin-top: 2rem;">
        ...
        <div style="overflow-x: auto;">
            <table class="data-table table-hover">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $metrics->filter(fn($m) => strtolower($m->platform) === 'youtube' && $m->jenis === 'Video'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex; gap:12px; align-items:center; justify-content: center;">
                                ...
                                <a href="javascript:void(0)" onclick="editVideo('<?php echo e($id_asli); ?>', <?php echo e(json_encode($metric)); ?>)" title="Edit" style="color: #f59e0b; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                </a>
                                <form action="<?php echo e(route('dashboard.metrics.destroy', ['yt-video', $id_asli])); ?>" method="POST" style="margin:0;">
...
<script>
function editVideo(id_konten, data) {
    const form = document.getElementById('form-yt-video');
    form.action = "<?php echo e(url('dashboard/metrics')); ?>/yt-video/" + id_konten;
    document.getElementById('method-container-yt-video').innerHTML = '<input type="hidden" name="_method" value="PUT">';
    document.getElementById('metric-id-yt-video').value = id_konten;
...
function resetFormYTVideo() {
    const form = document.getElementById('form-yt-video');
    form.reset();
    form.action = "<?php echo e(route('dashboard.metrics.store')); ?>";
    document.getElementById('method-container-yt-video').innerHTML = '';
    document.getElementById('metric-id-yt-video').value = '';
    document.getElementById('btn-submit-yt-video').innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px;"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path><polyline points="17 21 17 13 7 13 7 21"></polyline><polyline points="7 3 7 8 15 8"></polyline></svg> Simpan Data';
    document.getElementById('btn-reset-video').style.display = 'flex';
    document.getElementById('btn-cancel-video').style.display = 'none';
    form.classList.remove('form-edit-highlight');
}
</script><?php /**PATH C:\laragon\www\InsightHubBaru\frontend\resources\views/pages/Input/youtube/video.blade.php ENDPATH**/ ?>