<div id="tab-laporan" class="dashboard-container">
            ...
            <div class="lap-filter-row">
                ...
                <div class="lap-field" style="flex: 1; min-width: 220px;">
                    ...
                    <div class="lap-search">
                        ...
                        <input type="text" name="lap_search" placeholder="Cari judul konten, platform, kategori..." value="<?php echo e($lapFilters['search']); ?>">
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('dashboard')); ?>?tab=laporan" class="lap-btn-reset">Reset</a>
            </div>
        </div>
    </form>
    ...
    <div class="lap-table-card">
        ...
        <div class="lap-sort-bar">
            ...
            <a href="<?php echo e($buildSortUrl($col)); ?>" class="lap-sort-chip <?php echo e($lapFilters['sort'] === $col ? 'active' : ''); ?>">
                <?php echo e($label); ?> <?php echo $sortIcon($col); ?>
        ...
        <div class="lap-list">
            ...
            ?>
            <div class="lap-row-card" style="--lap-accent: <?php echo e($pColor); ?>; --lap-accent-soft: <?php echo e($pSoft); ?>;">
                <div class="lap-row-top">
                    <div class="lap-row-top-left">
                        <span class="lap-row-date"><i class="ph-bold ph-calendar-blank"></i> <?php echo e($row->tgl_upload ? \Carbon\Carbon::parse($row->tgl_upload)->format('d M Y') : '-'); ?></span>
                        <span class="lap-dot"></span>
                        <span class="lap-platform">
                            <span class="lap-platform-icon"><i class="ph-fill <?php echo e($pIcon); ?>" style="color: <?php echo e($pColor); ?>;"></i></span>
                            <?php echo e(ucfirst($row->platform)); ?>

                        </span>
                        <span class="lap-dot"></span>
                        <span class="lap-jenis"><?php echo e($row->jenis ?: '-'); ?></span>
                    </div>
                    <span class="lap-pill"><?php echo e($row->kategori ?: '-'); ?></span>
                </div>

                <div class="lap-row-title"><?php echo e($row->judul_konten ?: '-'); ?></div>
                ...
                <div class="lap-metrics">
                    ...
                    <div class="lap-metric-tile">
                        ...
                        <?php if($row->link): ?>
                        <a href="<?php echo e($row->link); ?>" target="_blank" class="lap-link"><i class="ph-bold ph-link"></i> Buka</a>
                        <?php else: ?>
        ...
        <div class="lap-pagination">
            <div>
                Menampilkan data <b><?php echo e($metricsLaporan->firstItem() ?? 0); ?></b> sampai <b><?php echo e($metricsLaporan->lastItem() ?? 0); ?></b> dari <b><?php echo e($metricsLaporan->total()); ?></b> total data
            </div>
            ...
            <div class="lap-page-nav">
                ...
                <?php else: ?>
                    <a href="<?php echo e($metricsLaporan->previousPageUrl()); ?>" class="lap-page-btn">Prev</a>
                <?php endif; ?>

                <span class="lap-page-current">Halaman <?php echo e($metricsLaporan->currentPage()); ?> dari <?php echo e($metricsLaporan->lastPage() ?: 1); ?></span>

                <?php if($metricsLaporan->hasMorePages()): ?>
                    <a href="<?php echo e($metricsLaporan->nextPageUrl()); ?>" class="lap-page-btn">Next</a>
                <?php else: ?>
...
</script><?php /**PATH D:\Project-Magang\InsightHub\frontend\resources\views\pages\Report\laporan.blade.php ENDPATH**/ ?>