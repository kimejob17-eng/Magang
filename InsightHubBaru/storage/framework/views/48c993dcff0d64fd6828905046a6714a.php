...
<div id="yt-tab-live" class="yt-tab-content">
    <div class="platform-form-card">
        <div class="platform-form-header">
            ...
            <div>
                <h2 style="font-size: 1.1rem; font-weight: 700; color: #0f172a; margin-bottom: 0.25rem;">YouTube Live</h2>
                <p style="font-size: 0.8rem; color: #64748b;">Input data performa siaran langsung YouTube.</p>
            </div>
        </div>
        ...
        <form action="<?php echo e(route('dashboard.metrics.store')); ?>" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <i class="ph-bold ph-eye" style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #64748b;"></i>
                        <input type="number" name="peak_viewers" class="form-control" style="padding-left: 2.5rem;" placeholder="0">
                    </div>
                </div>
            </div>
...
</div><?php /**PATH C:\laragon\www\InsightHubBaru\frontend\resources\views/pages/Input/youtube/live.blade.php ENDPATH**/ ?>