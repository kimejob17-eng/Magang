        ...
        <div class="lap-header">
            ...
            <div class="lap-export">
                <?php if(auth()->check() && auth()->user()->role === 'user'): ?>
                    ...
                    <?php if(auth()->user()->hasPermission('laporan.export-excel', 'view')): ?>
                    ...
                    <?php endif; ?>
                    <?php if(auth()->user()->hasPermission('laporan.export-pdf', 'view')): ?>
...
</script><?php /**PATH D:\magang\InsightHubBaru\frontend\resources\views/pages/Report/laporan.blade.php ENDPATH**/ ?>