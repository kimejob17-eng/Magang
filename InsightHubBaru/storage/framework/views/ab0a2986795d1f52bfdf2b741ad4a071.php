...
<div class="auth-page">
    ...
    <div class="auth-card">
        ...
        <!-- Form -->
        <form id="register-form" action="<?php echo e(route('register.post')); ?>" method="POST" class="auth-form" novalidate>
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="auth-switch">
            ...
            <a href="<?php echo e(route('login')); ?>" class="switch-link">Masuk</a>
        </div>
...
<?php /**PATH C:\laragon\www\InsightHubBaru\frontend\resources\views/auth/register.blade.php ENDPATH**/ ?>