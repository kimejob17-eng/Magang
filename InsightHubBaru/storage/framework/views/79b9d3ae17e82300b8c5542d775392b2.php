                ...
                <tbody style="color: #334155;">
                    ...
                    <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.15s ease;" onmouseover="this.style.background='#f8fafc';" onmouseout="this.style.background='none';">
                        ...
                        <td style="padding: 14px 16px; font-weight: 600;">
                            <?php echo e($req->user->name ?? 'Unknown'); ?>
                        ...
                        <td style="padding: 14px 16px;">
                            <div style="font-weight: 500;"><?php echo e($req->reason); ?></div>
                            <?php if($req->details): ?>
                            <div style="font-size: 0.775rem; color: #64748b; margin-top: 4px; background: #f8fafc; padding: 4px 8px; border-radius: 4px; border-left: 2.5px solid #cbd5e1;">Ket: <?php echo e($req->details); ?></div>
                            <?php endif; ?>
                        </td>
                        <td style="padding: 14px 16px; white-space: nowrap;">
                            ...
                            <?php else: ?>
                                ...
                                <div style="font-size: 0.775rem; color: #64748b; margin-top: 6px; padding: 4px 8px; background: #fef2f2; border-left: 3px solid #ef4444; border-radius: 4px; white-space: normal;">Alasan: <?php echo e($req->reject_reason); ?></div>
                            <?php endif; ?>
                        </td>
                        <td style="padding: 14px 16px; text-align: right; white-space: nowrap;">
                            <?php if(in_array(auth()->user()->role, ['super-admin', 'admin'])): ?>
                                <?php if($req->status === 'pending'): ?>
                                    <div style="display: flex; justify-content: flex-end; gap: 6px;">
                                        <button type="button" onclick="openRejectModal(<?php echo e($req->id); ?>)" style="padding: 6px 12px; background: #fff; color: #ef4444; border: 1px solid #fca5a5; border-radius: 8px; cursor: pointer; font-size: 0.8rem; font-weight: 600; transition: all 0.2s;" onmouseover="this.style.background='#fef2f2';" onmouseout="this.style.background='#fff';">
                                            Tolak
                                        </button>
                            ...
                            <?php else: ?>
                                <?php if($req->status === 'approved'): ?>
                                    <a href="<?php echo e(route('export-requests.download', $req->id)); ?>" style="display: inline-flex; align-items: center; gap: 6px; text-decoration: none; padding: 6px 14px; background: linear-gradient(135deg, #003EA8 0%, #00225c 100%); color: white; font-weight: 600; border-radius: 8px; font-size: 0.8rem; box-shadow: 0 4px 6px -1px rgba(0, 62, 168, 0.15); transition: all 0.2s; border: none; cursor: pointer;" onmouseover="this.style.transform='translateY(-1px)'; this.style.boxShadow='0 6px 10px -1px rgba(0, 62, 168, 0.25)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 6px -1px rgba(0, 62, 168, 0.15)';">
                    ...
                    <tr>
                        <td colspan="<?php echo e(in_array(auth()->user()->role, ['super-admin', 'admin']) ? '7' : '6'); ?>" style="padding: 32px 16px; text-align: center; color: #94a3b8;">
...
<?php /**PATH D:\magang\InsightHubBaru\frontend\resources\views/pages/Export/history.blade.php ENDPATH**/ ?>