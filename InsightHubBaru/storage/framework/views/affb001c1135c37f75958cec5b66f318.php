                ...
                <div class="hero-content">
                    <div class="hero-avatar" onclick="document.getElementById('pf-avatar-input').click()" style="cursor: pointer;" title="Ubah Foto Profil">
                        ...
                        <?php else: ?>
                            ...
                            <img id="hero-avatar-img" src="" alt="<?php echo e($user->name); ?>" class="avatar-img" style="display: none;">
                        <?php endif; ?>
                    ...
                    <div class="hero-info">
                        ...
                        <p class="hero-role">
                            <?php echo e(strtoupper($user->roleModel->name ?? $user->role ?? 'User')); ?>
                ...
                <section class="profile-card">
                    ...
                    <div class="account-info" style="margin-top: 1.5rem;">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-badge"><?php echo e(strtoupper($user->roleModel->name ?? $user->role ?? 'User')); ?></span>
                        </div>
                    </div>
...
<?php /**PATH D:\magang\InsightHubBaru\frontend\resources\views/pages/Profile/profile.blade.php ENDPATH**/ ?>