    ...
    kategoris.forEach(k => {
        ...
        tr.innerHTML = `
            ...
            <td style="padding: 12px; text-align: right; width: 100px;">
                <button type="button" onclick="editKategori(${k.id}, '${k.nama}')" style="background:none;border:none;color:#f59e0b;cursor:pointer;margin-right:8px;"><i class="ph-bold ph-pencil-simple"></i></button>
                <button type="button" onclick="deleteKategori(${k.id})" style="background:none;border:none;color:#ef4444;cursor:pointer;"><i class="ph-bold ph-trash"></i></button>
            </td>
        `;
...
<?php /**PATH C:\laragon\www\InsightHubBaru\frontend\resources\views/pages/Input/input.blade.php ENDPATH**/ ?>