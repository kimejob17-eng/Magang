...
<body>
    ...
    <header class="topnav" style="position: sticky; top: 0; z-index: 200;">
        ...
        <nav class="topnav-links">
            <a href="<?php echo e(route('dashboard')); ?>" class="topnav-item">Dashboard</a>
        ...
        <div class="topnav-right">
            <?php if(auth()->guard()->check()): ?>
                <div class="topnav-user-group">
                    <a href="<?php echo e(route('profile.show')); ?>" class="topnav-avatar-link" title="<?php echo e(auth()->user()->name); ?>">
                        <?php if(auth()->user()->avatar): ?>
                            <img src="<?php echo e(asset(auth()->user()->avatar)); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="topnav-avatar-img">
                        <?php else: ?>
                            <div class="topnav-avatar-initials"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 2))); ?></div>
                        <?php endif; ?>
                    </a>
                    ...
                    <form id="welcome-logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display:none;"><?php echo csrf_field(); ?></form>
                </div>
            <?php else: ?>
                <div class="topnav-user-group">
                    <a href="<?php echo e(route('login')); ?>" class="topnav-logout-btn" style="color:rgba(255,255,255,0.8); font-weight:600; padding: 0.4rem 1rem; border: 1px solid transparent; transition: color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,0.8)'">Log In</a>
                </div>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\laragon\www\InsightHubBaru\frontend\resources\views/welcome.blade.php ENDPATH**/ ?>