            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="kategori-wrapper">
                        ...
                        <a href="javascript:void(0)" onclick="openKategoriModal('instagram', this)" class="btn-tambah-kategori" title="Kelola Kategori" style="text-decoration:none; display:flex; align-items:center;"><i class="ph-bold ph-gear" style="margin-right:4px;"></i> Kelola</a>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="card" style="margin-top: 2rem;">
        ...
        <div style="overflow-x: auto;">
            <table class="data-table">
                ...
                <tbody>
                    {{-- Catatan: kolom "Interaksi" (total_interaksi) belum diekspos oleh
