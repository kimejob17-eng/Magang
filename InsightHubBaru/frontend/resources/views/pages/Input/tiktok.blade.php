...
<div id="content-tiktok" class="platform-content" style="display: none;">
    <div class="platform-form-card">
        ...
        <form id="form-tiktok" action="{{ route('dashboard.metrics.store') }}" method="POST">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="kategori-wrapper">
                        <select name="category" class="form-control" required>
                            ...
                            @foreach($kategoris->where('platform.slug', 'tiktok') as $kat)
    ...
    <div class="card" style="margin-top: 2rem;">
        ...
        <div style="overflow-x: auto;">
            <table class="data-table table-hover">
                ...
                <tbody>
                    @forelse($metrics->filter(fn($m) => strtolower($m->platform) === 'tiktok') as $metric)
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex; gap:12px; align-items:center; justify-content: center;">
                                ...
                                <a href="javascript:void(0)" onclick="editTikTok('{{ $id_asli }}', {{ json_encode($metric) }})" title="Edit" style="color: #f59e0b; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                </a>
                                <form action="{{ route('dashboard.metrics.destroy', ['tiktok', $id_asli]) }}" method="POST" style="margin:0;">
                                    @csrf @method('DELETE')
...
function editTiktok(id_konten, data) {
    ...
    form.action = "{{ url('dashboard/metrics') }}/tiktok/" + id_konten;
