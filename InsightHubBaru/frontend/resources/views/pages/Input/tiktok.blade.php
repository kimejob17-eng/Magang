            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="kategori-wrapper">
                        ...
                        <a href="javascript:void(0)" onclick="openKategoriModal('tiktok', this)" class="btn-tambah-kategori" title="Kelola Kategori" style="text-decoration:none; display:flex; align-items:center;"><i class="ph-bold ph-gear" style="margin-right:4px;"></i> Kelola</a>
                    </div>
                </div>
                <div class="form-group">
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($metric->likes + $metric->comments + $metric->shares) }}</td>
                        <td><a href="https://tiktok.com/{{ $metric->link }}" target="_blank" style="color: var(--primary);">View</a></td>
                    </tr>
                    @empty
