...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a class="nav-item" href="{{ route('dashboard') }}?tab=analitik">
                <i class="ph ph-chart-line-up"></i> Analitik Konten
            </a>
            <a class="nav-item" href="{{ route('dashboard') }}?tab=input">
                <i class="ph ph-plus-square"></i> Input Data
            </a>
            <a class="nav-item" href="{{ route('dashboard') }}?tab=laporan">
                <i class="ph ph-file-text"></i> Laporan
            </a>
            <a class="nav-item active" style="margin-top: 1rem;" href="{{ route('profile.show') }}">
        ...
        <header class="topbar">
            ...
            <div class="topbar-actions">
                <div class="user-profile">
                    <img id="topbar-avatar" src="{{ $user->avatar ? asset($user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=003EA8&color=fff&bold=true' }}" alt="{{ $user->name }}">
                </div>
            </div>
        </header>
            ...
            <div class="profile-hero">
                ...
                <div class="hero-content">
                    <div class="hero-avatar" onclick="document.getElementById('pf-avatar-input').click()" style="cursor: pointer;" title="Ubah Foto Profil">
                        <img
                            id="hero-avatar-img"
                            src="{{ $user->avatar ? asset($user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&size=96&background=003ea8&color=fff&bold=true' }}"
                            alt="{{ $user->name }}"
                            class="avatar-img"
                        >
                ...
                <section class="profile-card">
                    ...
                    <form id="profile-form" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="profile-form">
                        ...
                        <div class="pf-group @error('name') has-error @enderror">
                            ...
                            @error('name')
                                <span class="pf-error"><i class="ph ph-warning"></i> {{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <!-- Nomor Telepon -->
                        <div class="pf-group @error('phone') has-error @enderror">
                        ...
                        <!-- Lokasi -->
                        <div class="pf-group @error('location') has-error @enderror">
                            ...
                            <div class="pf-select-wrap">
                                ...
                                <select id="pf-location" name="location" class="pf-select">
                                    ...
                                    <option value="Jakarta, Indonesia" {{ old('location', $user->location) == 'Jakarta, Indonesia' ? 'selected' : '' }}>Jakarta, Indonesia</option>
                                    <option value="Bandung, Indonesia" {{ old('location', $user->location) == 'Bandung, Indonesia' ? 'selected' : '' }}>Bandung, Indonesia</option>
                                    <option value="Surabaya, Indonesia" {{ old('location', $user->location) == 'Surabaya, Indonesia' ? 'selected' : '' }}>Surabaya, Indonesia</option>
                                    <option value="Yogyakarta, Indonesia" {{ old('location', $user->location) == 'Yogyakarta, Indonesia' ? 'selected' : '' }}>Yogyakarta, Indonesia</option>
                                    <option value="Semarang, Indonesia" {{ old('location', $user->location) == 'Semarang, Indonesia' ? 'selected' : '' }}>Semarang, Indonesia</option>
                                    <option value="Medan, Indonesia" {{ old('location', $user->location) == 'Medan, Indonesia' ? 'selected' : '' }}>Medan, Indonesia</option>
                                    <option value="Makassar, Indonesia" {{ old('location', $user->location) == 'Makassar, Indonesia' ? 'selected' : '' }}>Makassar, Indonesia</option>
                                    <option value="Denpasar, Indonesia" {{ old('location', $user->location) == 'Denpasar, Indonesia' ? 'selected' : '' }}>Denpasar, Indonesia</option>
                                </select>
                ...
                <section class="profile-card">
                    ...
                    <div class="account-info">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-badge">{{ $user->role ?? 'User' }}</span>
                        </div>
                    </div>
