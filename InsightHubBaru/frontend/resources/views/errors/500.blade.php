...
<head>
    ...
    <title>Sovie — Koneksi Server Terputus (500)</title>
...
<body>
    ...
    <div class="error-card-container" style="z-index: 1;">
        ...
        <h2 class="error-title">Koneksi Server Terputus</h2>
        <p class="error-desc">Gagal menghubungkan sistem ke database server. Pastikan database server (MySQL/Navicat) sedang aktif dan berjalan dengan benar di sistem Anda.</p>
        <div class="action-btn-group">
            <button onclick="window.location.reload()" class="btn-action-primary">
                <i class="ph ph-arrow-counter-clockwise"></i>
                <span>Coba Hubungkan Lagi</span>
            </button>
            <a href="mailto:admin@sovie.com?subject=Laporan%20Koneksi%20Database%20Server%20Terputus" class="btn-action-secondary">
                <i class="ph ph-wrench"></i>
                <span>Lapor IT Support</span>
            </a>
        </div>
    </div>
</body>
