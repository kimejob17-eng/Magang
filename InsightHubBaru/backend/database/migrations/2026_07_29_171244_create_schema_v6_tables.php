...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // =========================================================
        // Jika tabel konten_youtube_shorts sudah ada tetapi
        // kolom shares belum ada, tambahkan kolom tersebut.
        if (
...
SELECT
    ...
    kf.likes AS suka,
    kf.comments AS komentar,
    kf.shares AS dibagikan,
...
-- =========================================================
SELECT
    CAST(CONCAT('IG-', ki.id) AS VARCHAR(50)),
    p.slug,
    p.nama,
    kk.nama,
    ki.judul,
    ...
    ki.likes AS suka,
    ki.comments AS komentar,
    ki.shares AS dibagikan,
...
-- =========================================================
SELECT
    CAST(CONCAT('TK-', kt.id) AS VARCHAR(50)),
    p.slug,
    p.nama,
    kk.nama,
    kt.judul,
    ...
    kt.likes AS suka,
    kt.comments AS komentar,
    kt.shares AS dibagikan,
...
-- =========================================================
SELECT
    CAST(CONCAT('YV-', yv.id) AS VARCHAR(50)),
    p.slug,
    p.nama,
    kk.nama,
    yv.judul,
    ...
    yv.likes AS suka,
    yv.comments AS komentar,
    yv.shares AS dibagikan,

    yv.penambahan_subscriber,
    0,
...
-- =========================================================
SELECT
    CAST(CONCAT('YS-', ys.id) AS VARCHAR(50)),
    p.slug,
    p.nama,
    kk.nama,
    ys.judul,
    ...
    ys.likes AS suka,
    ys.comments AS komentar,
    ys.shares AS dibagikan,

    ys.penambahan_subscriber,
    0,
...
-- =========================================================
SELECT
    CAST(CONCAT('YL-', yl.id) AS VARCHAR(50)),
    p.slug,
    p.nama,
    kk.nama,
    yl.judul,
    ...
    yl.likes AS suka,
    yl.comments AS komentar,
    yl.shares AS dibagikan,

    yl.penambahan_subscriber,
    yl.penonton_puncak,
